...
#include "ISXEQHUDMove.h"

// The mandatory pre-setup function.  Our name is "ISXEQHUDMove", and the class is ISXEQHUDMove.
...
// our instanced class.
ISXPreSetup("ISXEQHUDMove",ISXEQHUDMove);
...
unsigned int ISXEQHUDMoveXML=0;
...
void ISXEQHUDMove::ConnectServices()
{
...
void ISXEQHUDMove::RegisterCommands()
{
    // add any commands
...
void ISXEQHUDMove::RegisterAliases()
{
    // add any aliases
}

void ISXEQHUDMove::RegisterDataTypes()
{
    // add any datatypes
    // pMyType = new MyType;
...
void ISXEQHUDMove::UnRegisterCommands()
{
    // remove commands
    //    pISInterface->RemoveCommand("MyCommand");
}
void ISXEQHUDMove::UnRegisterAliases()
{
    // remove aliases
}
void ISXEQHUDMove::UnRegisterDataTypes()
{
    // remove data types
    //if (pMyType)
    //{
...
void ISXEQHUDMove::UnRegisterTopLevelObjects()
{
    // remove Top-Level Objects
    //    pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQHUDMove::UnRegisterServices()
{
    // shutdown our own services
    //    if (hISXEQHUDMoveService)
    //        pISInterface->ShutdownService(this,hISXEQHUDMoveService);
}

void ISXEQHUDMove::LoadSettings()
{
    bool bChanged=false;

    // open the settings file, and store the ID number in ISXEQHUDMoveXML
    ISXEQHUDMoveXML=pISInterface->OpenSettings(XMLFileName);
    ...
    Any set can be referred to by its ID.  The base set is stored in ISXEQHUDMoveXML.  Note that the settings
    ...
    */
    ...
    if (unsigned int GeneralGUID=pISInterface->FindSet(ISXEQHUDMoveXML,"General"))
    {
